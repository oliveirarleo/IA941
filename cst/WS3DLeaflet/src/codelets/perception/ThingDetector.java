...
public class ThingDetector extends Codelet {
    ...
    private MemoryObject knownThingsMO;

    public ThingDetector() {
    ...
    public void accessMemoryObjects() {
        ...
        this.knownThingsMO = (MemoryObject) this.getOutput("KNOWN_THINGS");
    }
    ...
    public void proc() {
        ...
        synchronized (visionMO) {
            ...
            known = Collections.synchronizedList((List<Thing>) knownThingsMO.getI());
            synchronized (vision) {
                for (Thing t : vision) {
                    boolean found = false;
                    synchronized (known) {
